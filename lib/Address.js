...
var Address = /** @class */ (function () {
    ...
    Address.prototype.toLegacyAddress = function (address) {
        ...
        var tent = Bitcoin.networks.tent;
        switch (prefix) {
            case "tent":
        ...
        var version = tent.pubKeyHash;
        switch (type) {
            case "P2PKH":
                version = tent.pubKeyHash;
                break;
            case "P2SH":
                version = tent.scriptHash;
                break;
        }
    ...
    Address.prototype.fromXPub = function (xpub, path) {
        ...
        if (xpub[0] === "x")
            ...
            bitcoincash = Bitcoin.networks.tentTest;
        var HDNode = Bitcoin.HDNode.fromBase58(xpub, bitcoincash);
    ...
    Address.prototype.fromXPriv = function (xpriv, path) {
        ...
        if (xpriv[0] === "x")
            ...
            bitcoincash = Bitcoin.networks.tentTest;
        var HDNode = Bitcoin.HDNode.fromBase58(xpriv, bitcoincash);
        var address = HDNode.derivePath(path);
        return this.toCashAddress(address.getAddress());
    };
    Address.prototype.fromOutputScript = function (scriptPubKey, network) {
        ...
        if (network !== "bitcoincash" && network !== "mainnet")
            netParam = Bitcoin.networks.tentTest;
    ...
    Address.prototype.transactions = function (address, page) {
    ...
    Address.prototype._decodeLegacyAddress = function (address) {
        ...
        var info = {
            main: Bitcoin.networks.tent,
            test: Bitcoin.networks.tentTest
        };
        var decoded = {
            prefix: "",
            type: "",
